"""Workbench render — fast, reliable, shows actual terrain + vegetation."""
...
OUT_DIR = REPO / "renders/coastal/m1_mountain_forest_workbench"
...
scene.display.shading.studiolight_intensity = 1.2
scene.display.shading.studio_light = "outdoor.sl"
...
manifest = {"unit_id": "m1_mountain_workbench", "out_dir": str(OUT_DIR),
            "engine": "BLENDER_WORKBENCH", "resolution": [1600, 900],
            "ok": all_ok, "renders": manifest_renders}
(OUT_DIR / "RENDER_MANIFEST.json").write_text(json.dumps(manifest, indent=2))
print(f"VB_MOUNTAIN_WORKBENCH_DONE all_ok={all_ok}")
