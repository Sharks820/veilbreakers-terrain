...
updates = {
    ...
    # handlers/__init__.py runtime-primary MCP bridge wrappers
    ('__init__.py', '_handle_generate_coastline'): 'A-|2026-04-19: confirmed A- -> defaults+keyword bridge into coastline.generate_coastline covered by dispatch registration/tests',
    ('__init__.py', '_handle_generate_world_map'): 'A-|2026-04-19: confirmed A- -> generate_world_map plus world_map_to_dict serialisation bridge',
    ('__init__.py', '_handle_compute_light_placements'): 'A-|2026-04-19: confirmed A- -> props/prop_positions aliasing then pure compute_light_placements delegation',
    ('__init__.py', '_handle_merge_lights'): 'A-|2026-04-19: confirmed A- -> direct merge_nearby_lights bridge',
    ('__init__.py', '_handle_light_budget'): 'A-|2026-04-19: confirmed A- -> direct compute_light_budget bridge',
    ('__init__.py', '_handle_compute_atmospheric_placements'): 'A-|2026-04-19: confirmed A- -> biome_name/area_bounds/seed bridge into atmospheric placement core',
    ('__init__.py', '_handle_volume_mesh_spec'): 'A-|2026-04-19: confirmed A- -> volume_type passthrough to compute_volume_mesh_spec',
    ('__init__.py', '_handle_atmosphere_performance'): 'A-|2026-04-19: confirmed A- -> placements passthrough to estimate_atmosphere_performance',
    ('__init__.py', '_handle_select_by_box'): 'A-|2026-04-19: confirmed A- -> tuple coercion into A-graded mesh._select_by_box',
    ('__init__.py', '_handle_select_by_sphere'): 'A-|2026-04-19: confirmed A- -> tuple+radius coercion into A-graded mesh._select_by_sphere',
    ('__init__.py', '_handle_select_by_plane'): 'A-|2026-04-19: confirmed A- -> plane-point/normal/side bridge into A-graded mesh._select_by_plane',
    ('__init__.py', '_handle_parse_selection_criteria'): 'A-|2026-04-19: confirmed A- -> criteria+strict bridge into A-graded parser',
    ('__init__.py', '_handle_smooth_assembled_mesh'): 'A-|2026-04-19: confirmed A- -> smooth_iterations/blend_factor/taubin_mu bridge into Taubin smoother',
    ('__init__.py', '_handle_compute_paint_weights'): 'A-|2026-04-19: confirmed A- -> brush-center/radius/falloff bridge into vectorised paint weights',
    ('__init__.py', '_handle_compute_paint_weights_uv'): 'A-|2026-04-19: confirmed A- -> UV brush bridge into vectorised paint weights',
    ('__init__.py', '_handle_blend_colors'): 'A-|2026-04-19: confirmed A- -> tuple coercion+mode bridge into blend_colors',
    ('__init__.py', '_handle_evaluate_mesh_quality'): 'A-|2026-04-19: confirmed A- -> verts/faces/uvs bridge into autonomous quality evaluator',
    ('__init__.py', '_handle_select_fix_action'): 'A-|2026-04-19: confirmed A- -> quality/targets/actions bridge into fix-action selector',
    ('__init__.py', '_handle_compute_weathered_vertex_colors'): 'A-|2026-04-19: confirmed A- -> mesh_data/base_color/preset bridge into weathering core',
    ('__init__.py', '_handle_apply_structural_settling'): 'A-|2026-04-19: confirmed A- -> strength/seed bridge into settling core',
    ('__init__.py', '_handle_generate_env_keyframes'): 'A-|2026-04-19: confirmed A- -> unified animation params dispatcher exercised through MCP dispatch suite',
    ('__init__.py', '_make_generator_handler'): 'A-|2026-04-19: confirmed A- -> signature-filtered kwargs bridge for animation_* command surfaces',
    ('__init__.py', '_h'): 'A-|2026-04-19: confirmed A- -> generated handler drops unknown kwargs and preserves callable signature contract',
    ('__init__.py', '_handle_terrain_preview_apply'): 'A-|2026-04-19: confirmed A- -> no_active_controller error contract + hash/history payload',
    ('__init__.py', '_handle_terrain_preview_state'): 'A-|2026-04-19: confirmed A- -> stable preview-state payload with no_active_controller guard',
    ('__init__.py', '_handle_terrain_preview_reset'): 'A-|2026-04-19: confirmed A- -> deterministic singleton reset contract',
    ('__init__.py', '_handle_terrain_preview_diff'): 'A-|2026-04-19: confirmed A- -> hash-before inference + missing_hash_before contract + diff passthrough',
    ('__init__.py', '_handle_terrain_preview_render_thumbnail'): 'A-|2026-04-19: confirmed A- -> missing_path/render_failed error contract + rendered path payload',
    ('__init__.py', '_handle_hot_reload_start'): 'A-|2026-04-19: confirmed A- -> lazy watcher init returns watched module list',
    ('__init__.py', '_handle_hot_reload_stop'): 'A-|2026-04-19: confirmed A- -> deterministic watcher teardown contract',
    ('__init__.py', '_handle_hot_reload_check'): 'A-|2026-04-19: confirmed A- -> check_and_reload result surfaced with stable ok payload',
    ('__init__.py', '_handle_read_viewport_vantage'): 'A-|2026-04-19: confirmed A- -> bbox coercion + serialized ViewportVantage MCP payload',
    ('__init__.py', '_handle_assert_vantage_fresh'): 'A-|2026-04-19: confirmed A- -> missing_vantage/viewport_stale contracts preserved',
    ('__init__.py', '_handle_is_in_frustum'): 'A-|2026-04-19: confirmed A- -> missing_vantage guard + bool frustum result',
    ('__init__.py', '_handle_addon_health'): 'A-|2026-04-19: confirmed A- -> min_version/allow_missing bridge with structured error payload',
    ('__init__.py', '_handle_detect_stale_addon'): 'A-|2026-04-19: confirmed A- -> thin stale-addon probe',
    ('__init__.py', '_handle_force_addon_reload'): 'A-|2026-04-19: confirmed A- -> thin force-reload probe',
    ('__init__.py', '_handle_boolean_safety_check'): 'A-|2026-04-19: confirmed A- -> solver recommendation+decimation+unsafe error contract',
    ('__init__.py', '_handle_convert_yup_to_zup'): 'A-|2026-04-19: confirmed A- -> coordinate-system bridge with list-serialised outputs',
    ('__init__.py', '_handle_clamp_screenshot_size'): 'A-|2026-04-19: confirmed A- -> requested/clamped contract around screenshot cap',
    ('__init__.py', '_handle_performance_report'): 'A-|2026-04-19: confirmed A- -> collect+serialize performance report bridge',
    ('__init__.py', '_handle_navmesh_export'): 'A-|2026-04-19: confirmed A- -> missing_params contract + Path coercion + descriptor payload',
    ('__init__.py', '_handle_validation'): 'A-|2026-04-19: confirmed A- -> missing_params contract + validation report serialisation',
    ('__init__.py', '_handle_load_quality_profile'): 'A-|2026-04-19: confirmed A- -> unknown_profile/preset_locked contracts + enum-safe serialisation',
    ('__init__.py', '_handle_list_quality_profiles'): 'A-|2026-04-19: confirmed A- -> stable profile list payload',
    ('__init__.py', '_handle_apply_quality_profile'): 'A-|2026-04-19: confirmed A- -> delegates to load-quality-profile contract for MCP callers',
    # terrain_features.py
    ('terrain_features.py', '_get_feature_noise'): 'A-|2026-04-19: upgraded new helper -> lru_cache maxsize=64 per-seed noise-provider reuse removes mutable singleton and repeated constructor churn',
    ('terrain_features.py', '_hash_noise'): 'A-|2026-04-19: upgraded B- -> per-seed cached generator via _get_feature_noise removes mutable module-global singleton cache',
    ('terrain_features.py', '_fbm'): 'A-|2026-04-19: upgraded C+ -> cached per-seed generator reuse exact geometric normalization zero-octave short-circuit',
    ...
    ('terrain_quixel_ingest.py', 'pass_quixel_ingest_bundle_k'): 'A-|2026-04-19: upgraded new helper -> explicit top-level bundle wrapper replaces synthetic _pass_wrap and preserves composition-hint asset sourcing',
    ...
    ('_water_network_ext.py', 'compute_wet_rock_mask'): 'A-|2026-04-19: upgraded B- -> nearest-seed EDT return_indices source-strength weighting from flow/discharge plus vectorised no-Scipy local stamps',
    ...
    ('terrain_waterfalls.py', 'pass_waterfall_mist'): 'A-|2026-04-19: confirmed A- -> mist copy/zero fallback connected-component decal extraction metrics and extra-channel write contract',
    ('terrain_waterfalls.py', 'register_bundle_c_mist_pass'): 'A-|2026-04-19: confirmed A- -> declarative supplemental mist-pass registration with channel contract',
    # runtime-primary R9 backfill tranche
    ('environment.py', 'handle_generate_terrain'): 'B+|2026-04-20: verified runtime handler by current tests -> terrain generation orchestration surface remains wired and callable',
    ('environment.py', 'handle_generate_terrain_tile'): 'B+|2026-04-20: verified runtime handler by current tests -> per-tile terrain generation handler remains wired',
    ('environment.py', 'handle_generate_world_terrain'): 'B+|2026-04-20: verified runtime handler by current tests -> world terrain orchestration surface remains callable',
    ('environment.py', 'handle_run_terrain_pass'): 'A-|2026-04-20: verified runtime handler by current tests -> pass-controller dispatch surface is wired and contract-bearing',
    ('environment.py', 'handle_generate_waterfall'): 'A-|2026-04-20: verified runtime handler by current tests -> waterfall generation entry remains wired to runtime surface',
    ('environment.py', 'handle_stitch_terrain_edges'): 'B+|2026-04-20: verified runtime handler by current tests -> terrain edge stitching handler remains callable',
    ('environment.py', 'handle_paint_terrain'): 'B+|2026-04-20: verified runtime handler by current tests -> terrain paint orchestration surface remains wired',
    ('environment.py', 'handle_carve_river'): 'B+|2026-04-20: verified runtime handler by current tests -> river carve runtime handler remains callable',
    ('environment.py', 'handle_create_water'): 'A-|2026-04-20: verified runtime handler by current tests -> water creation/export surface remains wired',
    ('environment.py', 'handle_carve_water_basin'): 'B+|2026-04-20: verified runtime handler by current tests -> basin carve runtime handler remains callable',
    ('environment.py', 'handle_export_heightmap'): 'A-|2026-04-20: verified runtime handler by current tests -> heightmap export surface remains wired',
    ('environment.py', 'handle_generate_multi_biome_world'): 'B+|2026-04-20: verified runtime handler by current tests -> multi-biome world generation surface remains callable',
    ('environment_scatter.py', 'handle_scatter_vegetation'): 'B+|2026-04-20: verified runtime handler by current tests -> scatter vegetation command surface remains registered and callable',
    ('environment_scatter.py', 'handle_create_breakable'): 'B+|2026-04-20: verified runtime handler by current tests -> breakable prop creation handler remains wired',
    ('lod_pipeline.py', 'handle_generate_lods'): 'B+|2026-04-20: verified runtime handler by current tests -> LOD generation bridge remains callable',
    ('procedural_materials.py', 'handle_create_procedural_material'): 'B+|2026-04-20: verified runtime handler by current tests -> procedural material handler remains wired',
    ('terrain_assets.py', 'pass_scatter_intelligent'): 'A-|2026-04-20: verified by current tests -> protected-zone-aware scatter pass emits runtime asset placement channels',
    ('terrain_assets.py', 'register_bundle_e_passes'): 'A-|2026-04-20: verified by current tests -> Bundle E registrar exposes scatter/asset passes with declarative contracts',
    ('terrain_audio_zones.py', 'register_bundle_j_audio_zones_pass'): 'A-|2026-04-20: verified by current tests -> declarative Bundle J audio-zone pass registration',
    ('terrain_bundle_j.py', 'register_bundle_j_passes'): 'A-|2026-04-20: verified by current tests -> Bundle J master registrar loads gameplay/audio/navmesh/ecotone/wind surfaces',
    ('terrain_bundle_k.py', 'register_bundle_k_passes'): 'A-|2026-04-20: verified by current tests -> Bundle K registrar loads material/shader/export passes in order',
    ('terrain_bundle_l.py', 'register_bundle_l_passes'): 'A-|2026-04-20: verified by current tests -> Bundle L registrar exposes atmosphere/fog/horizon/god-ray passes',
    ('terrain_bundle_n.py', 'register_bundle_n_passes'): 'A-|2026-04-20: verified by current tests -> Bundle N registrar remains wired on runtime pass controller',
    ('terrain_bundle_o.py', 'register_bundle_o_passes'): 'A-|2026-04-20: verified by current tests -> Bundle O registrar remains wired on runtime pass controller',
    ('terrain_caves.py', 'pass_caves'): 'A-|2026-04-20: verified by current tests -> cave pass writes cave channels and respects runtime pass contract',
    ('terrain_caves.py', 'register_bundle_f_passes'): 'A-|2026-04-20: verified by current tests -> Bundle F registrar exposes cave pass suite',
    ('terrain_caves.py', 'handle_generate_cave'): 'B+|2026-04-20: verified by current tests -> cave generation runtime handler remains callable',
    ('terrain_cliffs.py', 'pass_cliffs'): 'A-|2026-04-20: verified by current tests -> cliff pass remains wired with explicit channel contract',
    ('terrain_cliffs.py', 'register_bundle_b_passes'): 'A-|2026-04-20: verified by current tests -> Bundle B cliff/material registrar remains wired',
    ('terrain_cloud_shadow.py', 'register_bundle_j_cloud_shadow_pass'): 'A-|2026-04-20: verified by current tests -> declarative cloud-shadow pass registration',
    ('terrain_decal_placement.py', 'register_bundle_j_decals_pass'): 'A-|2026-04-20: verified by current tests -> declarative decal-placement pass registration',
    ('terrain_delta_integrator.py', 'register_integrator_pass'): 'A-|2026-04-20: verified by current tests -> delta-integrator registrar exposes stack integration pass',
    ('terrain_ecotone_graph.py', 'pass_ecotones'): 'A-|2026-04-20: verified by current tests -> ecotone runtime pass emits transition graph data with pass contract',
    ('terrain_ecotone_graph.py', 'register_bundle_j_ecotones_pass'): 'A-|2026-04-20: verified by current tests -> declarative Bundle J ecotone pass registration',
    ('terrain_fog_masks.py', 'register_bundle_l_fog_masks_pass'): 'A-|2026-04-20: verified by current tests -> declarative fog-mask pass registration',
    ('terrain_gameplay_zones.py', 'register_bundle_j_gameplay_zones_pass'): 'A-|2026-04-20: verified by current tests -> declarative gameplay-zone pass registration',
    ('terrain_geology_validator.py', 'register_bundle_i_passes'): 'A-|2026-04-20: verified by current tests -> Bundle I geology validator registrar remains wired',
    ('terrain_god_ray_hints.py', 'pass_god_ray_hints'): 'A-|2026-04-20: verified by current tests -> god-ray hint pass remains wired with runtime contract',
    ('terrain_god_ray_hints.py', 'register_bundle_l_god_ray_hints_pass'): 'A-|2026-04-20: verified by current tests -> declarative god-ray hint pass registration',
    ('terrain_horizon_lod.py', 'pass_horizon_lod'): 'A-|2026-04-20: verified by current tests -> horizon LOD pass remains wired with explicit output contract',
    ('terrain_horizon_lod.py', 'register_bundle_l_horizon_lod_pass'): 'A-|2026-04-20: verified by current tests -> declarative horizon-LOD pass registration',
    ('terrain_macro_color.py', 'pass_macro_color'): 'A-|2026-04-20: verified by current tests -> macro-color pass remains wired with runtime channel contract',
    ('terrain_macro_color.py', 'register_bundle_k_macro_color_pass'): 'A-|2026-04-20: verified by current tests -> declarative macro-color pass registration',
    ('terrain_materials_v2.py', 'pass_materials'): 'A-|2026-04-20: verified by current tests -> materials pass remains wired and produces splat/material channels',
    ('terrain_materials_v2.py', 'register_bundle_b_material_passes'): 'A-|2026-04-20: verified by current tests -> material-pass registrar remains wired',
    ('terrain_multiscale_breakup.py', 'pass_multiscale_breakup'): 'A-|2026-04-20: verified by current tests -> multiscale-breakup pass remains wired with runtime contract',
    ('terrain_multiscale_breakup.py', 'register_bundle_k_multiscale_breakup_pass'): 'A-|2026-04-20: verified by current tests -> declarative multiscale-breakup pass registration',
    ('terrain_navmesh_export.py', 'register_bundle_j_navmesh_pass'): 'A-|2026-04-20: verified by current tests -> declarative navmesh pass registration',
    ('terrain_quixel_ingest.py', 'register_bundle_k_quixel_ingest_pass'): 'A-|2026-04-20: verified by current tests -> explicit top-level bundle wrapper now registered for Quixel ingest pass',
    ('terrain_roughness_driver.py', 'register_bundle_k_roughness_driver_pass'): 'A-|2026-04-20: verified by current tests -> declarative roughness-driver pass registration',
    ('terrain_shadow_clipmap_bake.py', 'register_bundle_k_shadow_clipmap_pass'): 'A-|2026-04-20: verified by current tests -> declarative shadow-clipmap pass registration',
    ('terrain_stochastic_shader.py', 'register_bundle_k_stochastic_shader_pass'): 'A-|2026-04-20: verified by current tests -> declarative stochastic-shader pass registration',
    ('terrain_validation.py', 'pass_validation_full'): 'A-|2026-04-20: verified by current tests -> full validation pass remains wired with structured report contract',
    ('terrain_validation.py', 'register_bundle_d_passes'): 'A-|2026-04-20: verified by current tests -> Bundle D validation registrar remains wired',
    ('terrain_waterfalls.py', 'pass_waterfalls'): 'A-|2026-04-20: verified by current tests -> waterfall runtime pass remains wired across chain/foam/mist outputs',
    ('terrain_waterfalls.py', 'register_bundle_c_passes'): 'A-|2026-04-20: verified by current tests -> Bundle C registrar remains wired for waterfall systems',
    ('terrain_wildlife_zones.py', 'register_bundle_j_wildlife_zones_pass'): 'A-|2026-04-20: verified by current tests -> declarative wildlife-zone pass registration',
    ('terrain_wind_field.py', 'pass_wind_field'): 'A-|2026-04-20: verified by current tests -> wind-field pass remains wired with runtime channel contract',
    ('terrain_wind_field.py', 'register_bundle_j_wind_field_pass'): 'A-|2026-04-20: verified by current tests -> declarative wind-field pass registration',
