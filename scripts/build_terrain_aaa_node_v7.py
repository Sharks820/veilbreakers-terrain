...
OUT_DIR = REPO_ROOT / "output" / "aaa_node_v7"
...
def build_blender_scene(heightmap: Any, stack: Any) -> None:
    ...
    _log("  Creating water surface (generator: terrain-footprint depth water)...")
    try:
...
def write_summary(heightmap: Any, stack: Any) -> dict[str, Any]:
    ...
    summary = {
        "script": "build_terrain_aaa_node_v7.py",
        "seed": hex(SEED),
