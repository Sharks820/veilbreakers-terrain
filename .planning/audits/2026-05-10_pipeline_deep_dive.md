...
|---|---|---|---|
| `assets/` | 2.7 GB | GITIGNORE | Free PBR/HDRI/tree assets — large binary, regenerable per asset-fetch script (no fetch script in scripts/, but assets are reproducible from CC0 sources). Should NOT be committed; add `assets/` to `.gitignore`. |
