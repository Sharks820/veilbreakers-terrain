...
- Live handler callables scanned: `1961`
- Callables missing from the grade sheet: `462`
- Callables without any R9 grade attached via matching CSV row: `911`

Status distribution:
- `helper_reachable`: `1374`
- `orphan_candidate`: `93`
- `runtime_primary`: `258`
- `test_only_or_unwired`: `235`
