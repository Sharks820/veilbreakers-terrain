...
- Live handler callables scanned: `1832`
- Callables missing from the grade sheet: `495`
- Callables without any R9 grade attached via matching CSV row: `877`

Status distribution:
- `helper_reachable`: `1282`
- `orphan_candidate`: `92`
- `runtime_primary`: `226`
- `test_only_or_unwired`: `231`
