...
- Callables missing from the grade sheet: `648`
- Callables without any R9 grade attached via matching CSV row: `1117`

Status distribution:
- `helper_reachable`: `1072`
- `orphan_candidate`: `150`
- `registrar_declared_only`: `23`
- `runtime_primary`: `122`
- `test_only_or_unwired`: `228`
