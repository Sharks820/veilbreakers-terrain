...
- Generated: 2026-05-04T12:36:13.349325+00:00
...
- Total callables covered: **1876**
- Output CSV: `output/spreadsheet/INDUSTRY_BEST_PRACTICE_CALLABLE_MATRIX_2026_05_04.csv`
- Output CSV fingerprint: `sha256:94e5d96b4fac0d3c57df99144ff3f146042608084d3eebce63b7e92ddc0201b3`
...
- VERIFIED_LOW_RISK: 1738
- MISSING_GRADE: 136
- LOCK_WITH_REGRESSION_GATES: 2

## Domain Coverage

- generic: 413 callables; gates `direct_tests|invalid_input|determinism_when_seeded|coverage|integration_if_exposed`; phase Phase 0
...
- validation_qa: 151 callables; gates `issue_codes|golden_visual|performance_budget|determinism|low_spec|artifact_schema`; phase Phase 11-12
...
- export_runtime: 119 callables; gates `manifest_schema|unity_contract|scale_factor|roundtrip_read|artifact_presence`; phase Phase 10
