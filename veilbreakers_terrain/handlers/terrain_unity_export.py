...
def _supplemental_mesh_specs_json(stack: TerrainMaskStack) -> Dict[str, Any]:
    ...
    for raw_spec in list(stack.cliff_mesh_specs or []) + list(stack.cave_mesh_specs or []):
        ...
        serialized: Dict[str, Any] = {
            ...
            "normal": [],           # populated by Unity MikkTSpace recalculation on import
            "tangent": [],          # MikkTSpace tangents; baked per-prototype on Unity side
            "uv0": uvs if uvs and len(uvs) == len(vertices) else [],
            "uv1": [],              # lightmap UVs; auto-generated by Unity lightmapper
