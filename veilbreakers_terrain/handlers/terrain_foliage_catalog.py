...
SPECIES_TRIPO_CATEGORIES: Dict[str, Tuple[str, ...]] = {
    ...
    "fence_wood":            ("fence",),
    "fence_stone":           ("fence", "gate"),
    "sign_wooden":           ("signpost",),
    "sign_stone_waypoint":   ("signpost",),
    "walkway_stone_path":    ("cobble", "walkway", "path"),
    "walkway_dirt_path":     ("walkway", "path"),
    "walkway_plank":         ("walkway",),
    "flowers":               ("flower",),
    "ferns":                 ("fern",),
    "mushrooms":             ("mushroom",),
    "clovers":               ("flower",),
...
_CATEGORY_FALLBACK: Dict[str, str] = {
    ...
    "fence": "_fallback_prop", "gate": "_fallback_prop", "signpost": "_fallback_prop",
    "walkway": "_fallback_prop", "cobble": "_fallback_prop", "path": "_fallback_prop",
