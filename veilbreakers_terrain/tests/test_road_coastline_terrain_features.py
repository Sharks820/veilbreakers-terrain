...
class TestComputeMstEdges:
    ...
    def test_two_waypoints_single_edge(self):
        from veilbreakers_terrain.handlers.road_network import compute_mst_edges
...
class TestRoadTypeClassification:
    ...
    def test_short_distance_is_main(self):
        from veilbreakers_terrain.handlers.road_network import _classify_road_type
...
class TestSlopeComputation:
    ...
    def test_flat_slope_zero(self):
        from veilbreakers_terrain.handlers.road_network import _compute_slope_degrees
...
class TestSwitchbackGeneration:
    ...
    def test_no_switchback_on_flat(self):
        from veilbreakers_terrain.handlers.road_network import _generate_switchback_points
...
class TestIntersectionDetection:
    ...
    def test_crossing_segments_detected(self):
        from veilbreakers_terrain.handlers.road_network import _segments_near
...
class TestIntersectionClassification:
    ...
    def test_two_segments_T(self):
        from veilbreakers_terrain.handlers.road_network import _classify_intersection
...
class TestRoadMeshSpec:
    ...
    def test_cross_section_respects_requested_width_and_shoulder_taper(self):
        from veilbreakers_terrain.handlers.road_network import _road_cross_section_z
    ...
    def test_mesh_spec_structure(self):
        from veilbreakers_terrain.handlers.road_network import _road_segment_mesh_spec
    ...
    def test_bilinear_sampler_handles_single_row_and_single_column_heightmaps(self):
        from veilbreakers_terrain.handlers.road_network import _sample_heightmap_bilinear
...
class TestBridgeMeshSpec:
    def test_bridge_mesh_spec_uses_crowned_road_profile(self):
        from veilbreakers_terrain.handlers.road_network import _bridge_mesh_spec
...
class TestCoastlineStyles:
    ...
    def test_all_styles_defined(self):
        from veilbreakers_terrain.handlers.coastline import COASTLINE_STYLES
...
class TestGenerateCoastline:
    ...
    def test_rocky_coastline(self):
        from veilbreakers_terrain.handlers.coastline import generate_coastline
...
class TestCoastlineNoise:
    ...
    def test_hash_noise_range(self):
        from veilbreakers_terrain.handlers.coastline import _hash_noise
    ...
    def test_fbm_noise_deterministic(self):
        from veilbreakers_terrain.handlers.coastline import _fbm_noise
...
class TestTerrainFeaturesNoise:
    ...
    def test_hash_noise_reuses_per_seed_cache_across_mixed_seeds(self, monkeypatch):
        import veilbreakers_terrain.handlers.terrain_features as tf
...
class TestGenerateCliffFace:
    ...
    def test_basic_cliff(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_cliff_face
...
class TestGenerateSwampTerrain:
    ...
    def test_basic_swamp(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_swamp_terrain
...
class TestWaveEnergyStackChannel:
    ...
    def _make_flat_stack(self, size: int = 16, elevation: float = 5.0):
        import numpy as np
        from veilbreakers_terrain.handlers.terrain_semantics import TerrainMaskStack
