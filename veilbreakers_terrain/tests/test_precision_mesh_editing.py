...
class TestSelectByBox:
    ...
    def test_all_inside(self):
        from veilbreakers_terrain.handlers.mesh import _select_by_box
...
class TestSelectBySphere:
    ...
    def test_all_inside(self):
        from veilbreakers_terrain.handlers.mesh import _select_by_sphere
...
class TestSelectByPlane:
    ...
    def test_above_z_plane(self):
        from veilbreakers_terrain.handlers.mesh import _select_by_plane
...
class TestSelectionCriteriaWithPositions:
    ...
    def test_position_box_criteria(self):
        from veilbreakers_terrain.handlers.mesh import _parse_selection_criteria
...
class TestExtendedEditOperations:
    ...
    def test_move_accepted(self):
        from veilbreakers_terrain.handlers.mesh import _validate_edit_operation
...
class TestSmoothDisplacements:
    ...
    def test_smooth_spike(self):
        ...
        from veilbreakers_terrain.handlers.terrain_sculpt import compute_smooth_displacements
...
class TestFlattenDisplacements:
    ...
    def test_flatten_to_average(self):
        from veilbreakers_terrain.handlers.terrain_sculpt import compute_flatten_displacements
...
class TestStampDisplacements:
    ...
    def test_basic_stamp(self):
        from veilbreakers_terrain.handlers.terrain_sculpt import compute_stamp_displacements
