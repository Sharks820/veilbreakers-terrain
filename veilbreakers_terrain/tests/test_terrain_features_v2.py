...
class TestGenerateNaturalArch:
    ...
    def test_basic_arch(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_natural_arch
...
class TestGenerateGeyser:
    ...
    def test_basic_geyser(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_geyser
...
class TestGenerateSinkhole:
    ...
    def test_basic_sinkhole(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_sinkhole
...
class TestGenerateFloatingRocks:
    ...
    def test_basic_floating_rocks(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_floating_rocks
...
class TestGenerateIceFormation:
    ...
    def test_basic_ice_formation(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_ice_formation
...
class TestGenerateLavaFlow:
    ...
    def test_basic_lava_flow(self):
        from veilbreakers_terrain.handlers.terrain_features import generate_lava_flow
