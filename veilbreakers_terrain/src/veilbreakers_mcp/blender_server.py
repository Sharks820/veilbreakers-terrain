...
_LOC_HANDLERS: Dict[str, str] = {
    ...
    "object_create": "blender_object_create_primitive",
    "object_delete": "blender_object_delete",
    "object_transform": "blender_object_transform",
    "material_basic": "blender_material_assign_basic",
    "material_inspect": "blender_material_inspect",
    "light_setup": "blender_light_create_or_update",
    "camera_setup": "blender_camera_create_or_update",
    "camera_orbit_plan": "blender_camera_orbit_plan",
    "camera_apply_shot": "blender_camera_apply_shot",
    "render_output_check": "blender_render_output_check",
    "terrain_editability_report": "blender_terrain_editability_report",
    "terrain_bridge_health": "blender_terrain_bridge_health",
    "terrain_heightfield_mesh": "blender_terrain_heightfield_mesh_from_channels",
    "terrain_write_attribute": "blender_terrain_write_named_attribute",
    "terrain_scene_validate": "blender_terrain_scene_validate",
