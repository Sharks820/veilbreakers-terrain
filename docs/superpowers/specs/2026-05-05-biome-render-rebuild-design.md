...
### 11.4 Block 4 — Polish + rescue + infra + ecology demoted (~2 days, 13 PRs)
...
**Block 4 totals: 13 PRs, ~2 days (with refactor PRs being XL/L). #49-#54 may slip to v1.1 if Block 4 calendar is tight; #55-#62 must land for pilot acceptance.**

### 11.5 Block 5 — Unity-side workstream + cross-cutting hardening (25 PR groups / 40 line items by ownership, studio-team-scale)
...
#### 11.5.6 Dependency hardening + supply chain (2 PRs)
