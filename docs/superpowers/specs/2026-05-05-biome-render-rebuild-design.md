...
**Block 4 totals: 11 active PRs (after Phase 2 Fix 2.2 added #6/#7/#10 from Block 1, and Phase 2 Fix 2.3 deferred #49/#50/#51/#52/#54 alongside the already-deferred #53). Active: #6, #7, #10, #55, #56, #57, #58, #60, #61, #62, #64. ~2 days. PR #53 deferred to v1.1 per Fix 1.6 (see §11.8 #12); PRs #49/#50/#51/#52/#54 deferred to v1.1 per Phase 2 Fix 2.3 (see §11.8 #13). All 6 refactor PRs (#49-#54) now deferred as a single grouped v1.1 entry. #55-#62 + #64 plus the migrated #6/#7/#10 polish must land for pilot acceptance.**
...
**Block 5 totals (after Phase 2 Fix 2.1 severity split): 26 PR groups split into Block 5a (5 pilot-blocking Unity parity PRs: B5-U1 through B5-U5) + Block 5b (pilot-supporting infra: 9 of §11.5.1 + B5-C2 + B5-C6 + 3 of §11.5.3 + 4 of §11.5.5 + B5-T1 + B5-T4 + 2 conditional B5-DEP4/DEP5 + B5-CI1 conditional) + Block 6 (post-pilot maturity: B5-C1 + B5-C3 + B5-C5 + B5-T2/T3/T5/T6/T7 + B5-DEP2 + B5-DEP3 + B5-DOC1-4 = 13 deferred). Block 5a + Block 5b land during pilot calendar (~3–5 days with Unity engineer in parallel; +2 weeks for B5-U1 alone without). Block 6 deferred to v1.1 (see §11.6.1).**
...
|---|---|---|---|
| §11.5.2 Coherence | B5-C1 (channel registry + YAML safe_load lint), B5-C3 (#56↔#55 cycle ordering), B5-C5 (channel-registration documentation) | P1-P2 maturity | B5-C2 + B5-C6 already cover the pilot-critical writer-edit serialization rules in Block 5b. Remaining items are documentation / lint enforcement — non-blocking. |
...
**Block 6 totals: 13 PRs (3 + 5 + 2 + 4 — minus the 0 conditional already absorbed into 5b).** Lands as a single v1.1 batch alongside §11.8 #12 (`environment.py` 5-seam split / PR #53) and §11.8 #13 (PRs #49/#50/#51/#52/#54). v1.1 batch effort: ~3-5 focused days post-pilot.
